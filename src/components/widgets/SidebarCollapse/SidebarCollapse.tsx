...
const SidebarCollapse: FunctionComponent = (): JSX.Element => {
  ...
  return (
    <div
      className={
        'p-4 cursor-pointer border rounded-[0.75rem] text-gray-900 dark:text-gray-600 border-white dark:border-black transition hover:border-gray-200 dark:hover:border-gray-900'
      }
